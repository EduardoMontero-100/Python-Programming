...
class HospitalVendingMachine(VendingMachine):
    ...
    snack_prices = {"candy": 3.00, "soda": 2.50, "chips": 2.00, "cookies": 2.50}
    
    def __init__(self, inventory, serial, days_until_maintenance):
        print('Executing by the subclass')
    ...
    def print_days_until_maintenance(self):
        print(super().days_until_maintenance)
 
class SchoolVendingMachine(VendingMachine):
    
    student_debt = {'pepe' : 50.00, 'juana': 60.00}
    snack_prices = {"candy": 1.00, "soda": 0.50, "chips": 4.00, "cookies": 4.50}
    ...
    def print_student_debt(self, student_name):
        SchoolVendingMachine.student_debt[student_name]
